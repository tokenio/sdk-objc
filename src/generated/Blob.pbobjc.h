 ...
 **/
GPB_FINAL @interface BlobRoot : GPBRootObject
@end
 ...
 **/
GPB_FINAL @interface Blob : GPBMessage
...
GPB_FINAL @interface Blob_Payload : GPBMessage
 ...
 **/
GPB_FINAL @interface Attachment : GPBMessage
