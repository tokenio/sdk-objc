 ...
 **/
GPB_FINAL @interface Nextgenpsd2Root : GPBRootObject
@end
...
GPB_FINAL @interface NextGenPsd2AccountDetails : GPBMessage
...
GPB_FINAL @interface NextGenPsd2TransactionDetails : GPBMessage
...
GPB_FINAL @interface NextGenPsd2TransferMetadata : GPBMessage
...
GPB_FINAL @interface ReportExchangeRate : GPBMessage
...
GPB_FINAL @interface AccountReference : GPBMessage
