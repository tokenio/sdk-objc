 ...
 **/
GPB_FINAL @interface PricingRoot : GPBRootObject
@end
...
GPB_FINAL @interface TransferQuote : GPBMessage
...
GPB_FINAL @interface TransferQuote_Fee : GPBMessage
...
GPB_FINAL @interface TransferQuote_FxRate : GPBMessage
...
GPB_FINAL @interface Pricing : GPBMessage
...
GPB_FINAL @interface PricingInstructions : GPBMessage
