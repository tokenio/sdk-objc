...
Pod::Spec.new do |s|
    ...
    s.subspec "SDK" do |sdk|
      sdk.source_files = "src/*.{h,m,c}", "src/**/*.{h,m,c}"
      sdk.header_dir = "src"
      sdk.header_mappings_dir = "src"
      sdk.requires_arc = false
      sdk.dependency "#{s.name}/Services"
      sdk.dependency "OrderedDictionary"
    end
